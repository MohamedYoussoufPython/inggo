        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              GestureDetector(
                onTap: () => ref.read(driverProvider.notifier).toggleOnline(),
                child: Container(
              ...
              if (!driver.isOnline)
                Padding(
                  ...
                  child: Column(
                    children: [
                      Icon(Icons.motorcycle, size: 64.w, color: AppColors.textHint),
                      SizedBox(height: 16.h),
                      Text('Activez-vous pour recevoir des courses',
